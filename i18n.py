...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "params_locked_note": "🔒 These filters are fixed in the free plan to keep computation fast. The pool is pre-filtered to games with 30–300 reviews and ≥85% positive rating with Japanese localization.",
    ...
    "ja": {
        ...
        "params_locked_note": "🔒 無料プランでは、計算量を抑えるためフィルター条件は固定です。レビュー件数 30〜300件・好評率 85%以上・日本語対応ゲームを対象にしています。",
